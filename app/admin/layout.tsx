  ...
  if (status === "unauthenticated") {
    return (
      <div className="max-w-sm mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-xl font-bold text-gray-800 mb-2">Admin Login Required</h1>
        <p className="text-sm text-gray-500 mb-4">Please log in with an admin account to continue.</p>
        <button
    ...
    return (
      <div className="max-w-sm mx-auto px-6 py-24 text-center">
        ...
        <p className="text-sm text-gray-500">
          This account doesn&apos;t have admin access. Ask a store owner to set your role to &quot;admin&quot; in
          the database.
        </p>
      </div>
    );
  ...
  return (
    <div className="flex flex-col md:flex-row max-w-7xl mx-auto">
      <aside className="md:w-56 shrink-0 border-b md:border-b-0 md:border-r border-medex-border p-4">
        <p className="font-bold text-medex-primary-dark text-sm mb-4 px-2">{STORE.name} Admin</p>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm whitespace-nowrap ${
                  active ? "bg-medex-pista text-medex-primary-dark font-medium" : "text-gray-600 hover:bg-medex-pista"
                }`}
              >
